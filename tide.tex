...
and real kSZ $P_{\Theta_{kSZ}}$.
    (Dashed line) kSZ calculated from foreground filtered 21 cm density field $\delta_{fs}$;
...
\label{fig:r}
\end{figure}
With noise substracted 21 cm density field, we are able to have detectable cross correlations for $\ell\gtrsim 800$. 
